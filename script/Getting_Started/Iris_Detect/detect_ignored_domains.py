...
uri = '/v1/iris-detect/domains/ignored/'
...
# Params
monitor_id = 'VAmAy37m9d' # ID for specific monitor
escalation_types = [] # use to see specific escalated domains
tlds = []
risk_score_ranges = ''
# mx_exists =
domain_state = 'active'
